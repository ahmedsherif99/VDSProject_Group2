...
TEST_F(Manager_test, Cofactortruetest) {
    BDD_ID a = test_var->createVar("a");
    BDD_ID b = test_var->createVar("b");
    EXPECT_EQ(test_var->coFactorTrue(test_var->True(), test_var->topVar(test_var->True())),
              test_var->True()); // constant
...
TEST_F(Manager_test, Cofactorfalsetest) {
    BDD_ID a = test_var->createVar("a");
    BDD_ID b = test_var->createVar("b");
    EXPECT_EQ(test_var->coFactorFalse(test_var->False(), test_var->topVar(test_var->False())),
              test_var->False()); //constant
